...
export default function PurchaseOrderDetailPage() {
  ...
  const { data: order, mutate } = useSWR<PurchaseOrder>(`/api/purchase-orders/${params.id}`);
    ...
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          <Button variant="ghost" size="icon" onClick={() => router.push("/dashboard/purchasing")}>
        ...
        <div className="flex gap-2">
          <Button variant="outline" onClick={() => router.push(`/dashboard/purchasing/${params.id}/print`)}>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          ...
          <CardContent className="space-y-1 text-sm">
            ...
            <p className="text-muted-foreground">{order.supplier.code}</p>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-lg">{tc("date")}</CardTitle>
          </CardHeader>
          <CardContent className="space-y-1 text-sm">
